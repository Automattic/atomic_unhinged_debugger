		...
		do {
			...
			foreach ( $this->callbacks[ $priority ] as $the_ ) {
				...
				if ( 0 === $the_['accepted_args'] ) {
					AUD_Timer::instance()->start( 'call_user_func_array' , $the_['function'] );
					$value = call_user_func( $the_['function'] );
					AUD_Timer::instance()->stop( 'call_user_func_array' , $the_['function'] );
				} elseif ( $the_['accepted_args'] >= $num_args ) {
					AUD_Timer::instance()->start( 'call_user_func_array' , $the_['function'] );
					$value = call_user_func_array( $the_['function'], $args );
					AUD_Timer::instance()->stop( 'call_user_func_array' , $the_['function'] );
				} else {
					AUD_Timer::instance()->start( 'call_user_func_array:slice', $the_['function'] );
					$value = call_user_func_array( $the_['function'], array_slice( $args, 0, $the_['accepted_args'] ) );
					AUD_Timer::instance()->stop( 'call_user_func_array:slice', $the_['function'] );
				}
			}
